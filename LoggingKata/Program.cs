...
namespace LoggingKata
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            // This line turns the data of the string "lines" into an ITrackable[]
            ...
            Console.WriteLine($"{tacoBell_A.Name} and {tacoBell_B.Name} are the 2 furthest Taco Bells in Alabama.");
